...
they iterate until APPROVED, generate SPEC.md, the user approves via the Web UI, and Claude Code
...
- When the user says "wrap up", update PROGRESS_V2.md, then suggest a single-line
